...
import { buyerPages, whoWeServeMeta, type ServiceFeatureCard } from "@/data/site";
...
export default function BuyerPage() {
  ...
  const statsColClass =
    page.stats.length === 4 ? "grid-cols-2 lg:grid-cols-4" : "grid-cols-3";
    ...
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-16 pt-28 sm:px-6 md:pb-20 md:pt-36 lg:px-8">
          <div className="max-w-[600px]">
            ...
            <div className="mt-10 border-t border-white/10 pt-8">
              <p className="label text-ivory/40">{page.trustLabel}</p>
              <div className="mt-4 flex flex-wrap items-center gap-x-7 gap-y-3">
                {page.trustLogos.map((name) => (
                  <span
                    key={name}
      ...
      <section className="bg-navy py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
            <div>
              <p className="label text-gold">{page.builtForEyebrow}</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[0.55fr_1.45fr] lg:items-start">
            ...
            <div
              className={cn(
                "grid gap-4",
                page.engagementCards.length <= 3 ? "sm:grid-cols-3" : "sm:grid-cols-2 lg:grid-cols-4",
              )}
            >
              {page.engagementCards.map((card) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="inline-flex items-center text-goldDark">
          ...
          {page.engagementBonus && (() => {
            ...
            return (
              <div className="mt-6 flex items-start gap-5 rounded-lg border border-gold/30 bg-parchment p-5 lg:ml-[30%]">
      ...
      <section className="bg-ink py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              {page.stats.map((stat) => {
                ...
                return (
                  ...
                  >
                    ...
                    {stat.label && <p className="label mt-3 text-ivory/55">{stat.label}</p>}
                    {stat.detail && (
          ...
          {/* ── OUR APPROACH (within proven impact dark section) ── */}
          <div className="mt-10 grid gap-6 lg:grid-cols-2">
            <div className="rounded-lg border border-white/10 bg-white/5 p-6">
              <p className="label text-gold">{page.approachEyebrow}</p>
              <ul className="mt-5 grid gap-3">
